			...
			<div className="container mx-auto px-6 py-16">
				...
				<div className="flex flex-col items-center justify-center sm:h-[80vh]">
					...
					<div className="flex flex-col sm:flex-row gap-4 mb-12">
						<Link href="/roadmaps" className="px-8 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-center font-semibold">
							View Roadmaps
						</Link>
						<Link href="/register" className="px-8 py-3 bg-white text-slate-900 rounded-lg hover:bg-slate-300 transition-colors text-center font-semibold">
							Get Started
						</Link>
					</div>
