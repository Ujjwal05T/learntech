      ...
      <div className="min-h-screen flex flex-col items-center justify-center bg-[#0a0a20] relative overflow-hidden">
        ...
        <div className="p-4 max-w-md w-full relative z-10">
          <div className="flex flex-col items-center">
            ...
            <p className="text-blue-400 font-medium">Loading event details...</p>
          </div>
        </div>
      </div>
    )
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-6 rounded-xl border border-white/10 shadow-lg">
                  <div className="flex items-start">
                    ...
                    <div>
                      <p className="text-xs text-blue-400 font-medium uppercase tracking-wider mb-1">Date & Time</p>
                ...
                {event.location && (
                  <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-6 rounded-xl border border-white/10 shadow-lg">
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="text-xs text-purple-400 font-medium uppercase tracking-wider mb-1">Location</p>
                ...
                {event.organizer && (
                  <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md p-6 rounded-xl border border-white/10 shadow-lg">
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="text-xs text-pink-400 font-medium uppercase tracking-wider mb-1">Organizer</p>
        ...
        >
          ...
          <div className="p-6 bg-black/20">
            <form onSubmit={handleAskQuestion} className="space-y-4">
              <div>
                <label htmlFor="question" className="block text-sm font-medium text-blue-400 mb-2">Ask a Question</label>
                <textarea 
                  id="question"
                  value={askQuestion}
          ...
          <div className="divide-y divide-white/10">
            {questions && questions.length > 0 ? (
              questions.map((question) => {
                ...
                const hasUpvoted = user && question.upvotedBy?.includes(user?.username || '');
                
                return (
                  <div key={question._id} className="p-6 hover:bg-white/5 transition-colors">
  ...
  <div className="mt-4">
    ...
    {answeringQuestion === question._id && (
      <div className="mt-4 p-4 bg-white/5 border border-white/10 rounded-xl">
        <label htmlFor="answer" className="block text-sm font-medium text-blue-400 mb-2">
          {question.answer ? 'Edit your answer' : 'Your answer'}
        </label>
        <textarea
          id="answer"
          value={answerText}
        ...
        <div className="mt-4 flex justify-end space-x-3">
          ...
          <button
            ...
            className={`px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg shadow-blue-600/20 ${
              answerLoading ? 'opacity-70 cursor-wait' : ''
            }`}
          >
            {answerLoading ? (
                        ...
                        {question.answer && (
                          <div className="mt-4 bg-white/5 rounded-xl p-4">
                            <div className="flex items-center mb-2">
                              ...
                              <span className="text-green-400 font-medium">Answer from organizer</span>
                            </div>
              ...
              <div className="p-8 text-center text-gray-400">
                <svg className="w-12 h-12 mx-auto mb-4 text-gray-500/50" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
                <p className="text-lg">No questions have been asked yet</p>
                <p className="mt-2">Be the first to ask a question about this event!</p>
              </div>
            )}
          </div>
        </motion.div>
