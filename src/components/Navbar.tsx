...
function Navbar() {
	...
	return (
		<nav
			className={cn("fixed top-0 left-0 right-0 z-50 transition-all duration-300", isScrolled ? "bg-[#060317]/90 backdrop-blur-sm border-b border-slate-800/50 h-12" : "bg-[#060317] h-16")}
		...
		>
			...
			<div id="mobile-menu" className={cn("md:hidden fixed inset-0 z-50 transition-all duration-300 ease-in-out", isOpen ? "opacity-100" : "opacity-0 pointer-events-none")}>
				{/* Backdrop */}
...
const ProfileButton = () => {
	return (
		<Link href="/profile">
			<Button className="ml-3 bg-blue-600 hover:bg-blue-700 shadow-lg shadow-blue-600/20 flex items-center" aria-label="View Profile">
				<LucideUser className="w-4 h-4 mr-2" />
				Profile
			</Button>
		</Link>
