...
import { LucideMenu, LucideX, LucideUser, LucideHome, LucideMap, LucideNewspaper, LucideCalendar } from "lucide-react";
...
function Navbar() {
    ...
    return (
        <>
            ...
            {/* Mobile Menu with Simple Transitions */}
            <div 
                className={cn(
